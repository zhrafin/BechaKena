        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar">
            <div class="position-sticky">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="winning_bids.php"><i class="fas fa-trophy me-2"></i><span>Winning Bids</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="winning-bids-card">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            // Fetch winning bids data
                            $sql = "
                                SELECT a.title, a.current_bid as final_price, b.bid_time as end_time 
                                FROM auction_items a
                                JOIN bids b ON a.id = b.item_id
                                WHERE a.winner_id = ? AND b.bid_amount = a.current_bid
                            ...
                            if ($stmt->execute()) {
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='3'>No winning bids found.</td></tr>";
                                }
                            } else {
